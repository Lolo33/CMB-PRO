    ...
    <div class="row">
        ...
        <div class="col-lg-9 cont-tool espace-top">
            <div id="contenu-doc" class="espace-top">
                ...
                <h4 class="titre-gerer">Informations Génerales</h4>
                <div class="conteneur-light">
                    ...
                    <div class="row">
                        <div class="espace-bot col-lg-12 new-line-info-api">
                            ...
                            <div class="info-api">
                                <input id="input-api-key" class="form-control" type="text" style="display: inline-block;" readonly="" value="<?php echo $session_token->getValue(); ?>" />
                                <button style="margin-left: 30px; display: inline-block;" class="btn btn-primary disabled">Obtenir une nouvelle clé d'API</button>
                            </div>
                        </div>
                    </div>
                </div>
               ...
               <h4 class="titre-gerer"  style="margin-top: 40px;">Quelques Statistiques</h4>

                        <div class="conteneur-light">
                        <?php try {
                            $plage = $CmbApi->PlageHorairesAction->Get(8);
                            $tarif = $CmbApi->DeterminerTarifReservation($plage);
                            var_dump($tarif);
                            $listeReservations = $CmbApi->ReservationsAction->GetAll();
                        ?>
                            <div class="row new-line-info-api">
                                <div class="col-lg-6">
                                    <div class="titre-info-api">Dernieère réservation:</div>
                                    <div class="info-api">
                            ...
                            <div class="row new-line-info-api">
                                <div class="col-lg-6">
                                    ...
                                    <div class="info-api">
                                        <strong><?php echo count(getReservationsTriees($listeReservations, "m-Y")); ?></strong>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="titre-info-api">Reservations cette année:</div>
                                    <div class="info-api">
                                        <strong><?php echo count(getReservationsTriees($listeReservations, "Y")); ?></strong>
                                    </div>
                                </div>
                            </div>

                            <!--<hr class="separateur-light">-->
                        <?php
                        }catch(\CmbSdk\Exceptions\ReponseException $ex){
                            echo 'Erreur: ' . $ex->getReponse() . '<br />' . $ex->getMessage();
                        }
                        ?>
                        </div>
